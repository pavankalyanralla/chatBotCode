...
class Langchain(Resource):
    def post(self):
        ...
        openai.api_key = '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'
        model = whisper.load_model('base.en')
        ffmpeg_path = "C:\\Users\\Pavan Kalyan R-2759\\Downloads\\ffmpeg\\ffmpeg-master-latest-win64-gpl\\bin\\ffmpeg.exe"
        # video_path = "D:\\chatGPT\\POC_GPT\\POC_GPT\\src\\server\\langChain\\videowithaudio.mp4"
        video_path = "C:/Users/Pavan Kalyan R-2759/Downloads/"+file.filename
        output_audio_path = 'D:\chatGPT\POC_GPT\POC_GPT\src\server\langChain\extractedAudiFile\\'+file.filename+'.wav'
